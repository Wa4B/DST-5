...
public class Run {
	public static void main(String args[]){
		...
		table.setValue("Jonh", "111-1111");table.setValue("No", "123-4568");
		table.setValue("Sam", "222-2222");table.setValue("Jee", "456-7890");
		table.setValue("Sandra", "333-3333");table.setValue("Jaewon", "000-0000");
